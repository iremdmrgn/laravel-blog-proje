...
<nav class="fixed w-full z-50 bg-white shadow-md">
    ...
    <section class="relative min-h-screen flex flex-col items-center justify-center text-center">
        ...
        <div class="absolute inset-0">
            <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1950&q=80" alt="Arka Plan" class="w-full h-full object-cover">
            <div class="absolute inset-0 bg-gradient-to-b from-indigo-900 via-transparent to-indigo-900 opacity-80"></div>
        </div>

        <!-- İçerik -->
        <div class="relative z-10 text-white px-4">
            <h1 class="text-5xl md:text-6xl font-extrabold mb-6 drop-shadow-lg">MyBlog’a Hoş Geldiniz</h1>
